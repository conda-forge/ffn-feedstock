...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ffn-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12534&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ffn-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ffn` can be installed with:

```
conda install ffn
```

It is possible to list all of the versions of `ffn` available on your platform with:
